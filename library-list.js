...
ENV.libraryList = [
    { code: 'angular-light', name: 'Angular Light', path: './angular-light/' },
    { code: 'angularjs', name: 'Angular.js', path: './angularjs/' },
    { code: 'angularjs2', name: 'Angular.js 2', path: './angularjs2/' },
    ...
    { code: 'reactjs', name: 'React.js', path: './reactjs/' },
    { code: 'blocksjs', name: 'Blocks.js', path: './blocksjs/' }
];
